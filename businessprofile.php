        ...
        <div class="row d-flex col-12 justify-content-center">
            <form class="col-12" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <div class="form-group row d-flex col-12 justify-content-center">
                    ...
                    <select data-placeholder="Choose Categories" id="category" multiple class="chosen" >
                ...
                <div class="form-group row d-flex col-12 justify-content-center">
                    ...
                    <select data-placeholder="Choose Products/Services" id= "prod"  multiple class="chosen">
                ...
                <div class="form-group row d-flex col-12 justify-content-center">
                    ...
                    <select data-placeholder="Choose Counties" multiple class="chosen">
