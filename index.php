...
<body class="pl-md-3 mr-3 mr-md-0">
...
<div class="container mx-auto mt-5 how-box outline-1 justify-content-center mid-body">
    <div class="row" id="main-form">
        <div class="hidden-sm col-md-6" id="football-image"></div>
        <div class="col-12 pl-5  col-md-6">
        <h3 class="row wrap p-4 gethead">GET NON-BINDING OFFERS – SAVE TIME AND MONEY ON SPORT PURCHASES 
        </h3>
...
<div class="container mx-auto mt-5 outline-1 justify-content-center how-box" id="an1">
...
<div class="container mx-auto mt-5 outline-1 justify-content-center how-box1" id="an2">
        <div class="row d-flex justify-content-around ml-4 pr-5 flex-wrap">
        <h2 class="my-1 ml-2 gethead">
...
<!-- partner+blog-->
<div class="container row mx-auto mt-5 p-0 mb-5 d-flex outline-1 justify-content-center align-items-center" id="partner-blog">
  ...
  <div class="d-flex col-sm-12 col-md-6 justify-content-center align-items-center" id="blog-div">
        ...
        <div class="icontext-x col-sm-5 col-md-5 justify-content-center align-items-center">
