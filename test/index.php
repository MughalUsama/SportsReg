...
<div class="container-fluid mx-auto mt-5 how-box justify-content-center mid-body">
    <div class="row" id="main-form">
        ...
        <h3 class="row wrap p-4 gethead">GET NON-BINDING OFFERS – SAVE TIME AND MONEY ON SPORTS PURCHASES 
        </h3>
...
<div class="container-fluid mx-auto mt-1 justify-content-center how-box" id="an1">
        <div class="row d-flex justify-content-around ml-4 pr-5 flex-wrap an1div">
        <h2 class="my-1 ml-2 gethead">
        How it works
        </h2>
        </div>
        
        <hr class="py-0" width="175">
        <div class="d-flex mt-5 ml-5 justify-content-around flex-wrap myicons">
            <div class="icontext justify-content-center align-items-center" id="transf-1">
...
<!-- Save money part-->
<div class="container-fluid mx-auto mt-1 justify-content-center" id="save-money">
        <div class="row d-flex justify-content-around ml-4 pr-5 flex-wrap savemoneydiv">
...
<div class="container-fluid mx-auto mt-1 justify-content-center how-box1" id="an2">
        ...
        <hr class="py-0" width="175">
        <div class="d-flex mt-5 ml-5 py-5 justify-content-around flex-wrap myicons">
            <div class="icontext-z justify-content-center align-items-center" id="transf-4">
                <div class="row custom-numbering"><h6 class="font-weight-bold"><span><pre class="round-back d-inline"> &#x2714; </pre></span> Get offers from several suppliers</h6></div>
            ...
            <div class="icontext-z justify-content-center align-items-center" id="transf-5">
                <div class="row custom-numbering"><h6 class="font-weight-bold"><span><pre class="round-back d-inline"> &#x2714; </pre></span> Choose the best offer based on your needs</h6></div>
                <div class="row icontext1"><p>By using SportsReg, your request is sent to several suppliers who would like you as a customer. This means that they will give good offers to win just you, and in this way the price can be pushed to the extreme to your advantage.</p></div>

            </div>
            <div class="icontext-z justify-content-center align-items-center" id="transf-6">
                <div class="row custom-numbering"><h6 class="font-weight-bold"><span><pre class="round-back d-inline"> &#x2714; </pre></span> It's free and without obligation!</h6></div>
...
<!-- partner+blog-->
<div class="container-fluid row mx-auto mt-1 p-0 d-flex justify-content-center align-items-center" id="partner-blog">
  <div class="d-flex col-sm-12 col-md-6 justify-content-center align-items-center" id="partner-div">
            <div class="justify-content-center align-items-center">
                <img class="row ic4" src="./img/partnerimg.png" alt="Partner">
            </div>

  </div>
  <div class="d-flex col-sm-12 col-md-6 justify-content-center align-items-center" id="blog-div">
        <div class="col-sm-7 col-md-7 justify-content-md-end align-items-center">
                <img class="row float-md-right ic5" src="./img/blog2.png"  alt="Blog">
        </div>
        <div class="icontext-x col-sm-5 col-md-5 justify-content-center align-items-start">
                <h1 class="ml-2 mb-4"><b class="mx-auto mb-4">OUR BLOG</b></h1>
