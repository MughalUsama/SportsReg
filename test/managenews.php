...
if (isset($_REQUEST["addnews"]))
{
    ...
    $addnews ="INSERT INTO `news`(`news_headline`, `news_description`, `image_name`, `top_news`, `latest_news`) VALUES (\"$headline\",\"$description\",\"$newname\",\"$topnews\",\"$latestnews\")";
    if(db::getInstance()->dbquery($addnews))
    {
        $successmsg = "Post added successfully";
    }
}
$allnews = "SELECT * FROM news ORDER BY top_news DESC, latest_news DESC, posted_on DESC";
...
<div class="container-fluid">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" placeholder="Write News/Post Headline" name="newsheadline" id="exampleFormControlTextarea1" rows="3" maxlength="190" required></textarea>
    </div>
    <div class="form-group">
